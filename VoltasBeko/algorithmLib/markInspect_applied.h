...
#define NLOHMANN_OPTIONAL_markInspection_tools_HELPER
	...
	private:
		...
		FullRoi rect_roi_outer;
		int64_t threshold_outer;
		int64_t fill_percent_outer;
		bool enabled_outer;
		std::string name;
	...
	public:
		...
		const bool& get_enabled_measure() const { return enabled_measure; }
		bool& get_mutable_enabled_measure() { return enabled_measure; }
		void set_enabled_measure(const bool& value) { this->enabled_measure = value; }

		const FullRoi& get_rect_roi_outer() const { return rect_roi_outer; }
		FullRoi& get_mutable_rect_roi_outer() { return rect_roi_outer; }
		void set_rect_roi_outer(const FullRoi& value) { this->rect_roi_outer = value; }

		const int64_t& get_threshold_outer() const { return threshold_outer; }
		int64_t& get_mutable_threshold_outer() { return threshold_outer; }
		void set_threshold_outer(const int64_t& value) { this->threshold_outer = value; }

		const int64_t& get_fill_percent_outer() const { return fill_percent_outer; }
		int64_t& get_mutable_fill_percent_outer() { return fill_percent_outer; }
		void set_fill_percent_outer(const int64_t& value) { this->fill_percent_outer = value; }

		const bool& get_enabled_outer() const { return enabled_outer; }
		bool& get_mutable_enabled_outer() { return enabled_outer; }
		void set_enabled_outer(const bool& value) { this->enabled_outer = value; }
	...
	private:
		...
		int64_t colour_id;
		//fixture ref
		int64_t fixtureType; //no reference(fixed position), fixture( move wrt fixture), fixture and other tool(move wrt fixture then other tool), other tool (only other tool) 
		int64_t fixtureToolReference;//id of other tool to be referred,
		int64_t fixture_mode;
		//fixture ref
		int64_t threshold;
		int64_t threshold_type;
		std::string name;
	...
	public:
		...
		//fixture ref
		const int64_t& get_fixtureType() const { return fixtureType; }
		int64_t& get_mutable_fixtureType() { return fixtureType; }
		void set_fixtureType(const int64_t& value) { this->fixtureType = value; }

		const int64_t& get_fixtureToolReference() const { return fixtureToolReference; }
		int64_t& get_mutable_fixtureToolReference() { return fixtureToolReference; }
		void set_fixtureToolReference(const int64_t& value) { this->fixtureToolReference = value; }

		const int64_t& get_fixture_mode() const { return fixture_mode; }
		int64_t& get_mutable_fixture_mode() { return fixture_mode; }
		void set_fixture_mode(const int64_t& value) { this->fixture_mode = value; }
		//fixture ref
	...
	inline void from_json(const json& j, LstBoundaryGapTool& x) {
		...
		x.set_enabled_measure(j.at("Enabled_measure").get<bool>());
		x.set_rect_roi_outer(j.at("Rect_roi_outer").get<FullRoi>());
		x.set_threshold_outer(j.at("Threshold_outer").get<int64_t>());
		x.set_fill_percent_outer(j.at("FillPercent_outer").get<int64_t>());
		x.set_enabled_outer(j.at("Enabled_outer").get<bool>());
	...
	inline void to_json(json& j, const LstBoundaryGapTool& x) {
		...
		j["Enabled_measure"] = x.get_enabled_measure();
		j["Rect_roi_outer"] = x.get_rect_roi_outer();
		j["Threshold_outer"] = x.get_threshold_outer();
		j["FillPercent_outer"] = x.get_fill_percent_outer();
		j["Enabled_outer"] = x.get_enabled_outer();
		j["Name"] = x.get_name();
	...
	inline void from_json(const json& j, LstCroiTool& x) {
		...
		//fixture ref
		x.set_fixtureType(j.at("FixtureType").get<int64_t>());
		x.set_fixtureToolReference(j.at("FixtureToolReference").get<int64_t>());
		x.set_fixture_mode(j.at("Fixture_mode").get<int64_t>());
		//fixture ref
		x.set_threshold(j.at("Threshold").get<int64_t>());
		x.set_threshold_type(j.at("ThresholdType").get<int64_t>());
		x.set_name(j.at("Name").get<std::string>());
	...
	inline void to_json(json& j, const LstCroiTool& x) {
		...
		//fixture ref
		j["FixtureType"] = x.get_fixtureType();
		j["FixtureToolReference"] = x.get_fixtureToolReference();
		j["Fixture_mode"] = x.get_fixture_mode();
		//fixture ref
		j["Threshold"] = x.get_threshold();
		j["ThresholdType"] = x.get_threshold_type();
		j["Name"] = x.get_name();
